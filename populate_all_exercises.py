#!/usr/bin/env python3
"""
Script to populate the production database with all 109 exercises
"""
import sqlite3
...
def populate_all_exercises():
    ...
    # All 109 exercises from your list
    exercises = [
        # SQUATS & LOWER BODY
    ...
    conn.commit()
    conn.close()
    print(f'✅ Successfully added {len(exercises)} exercises to the production database!')
